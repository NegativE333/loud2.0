...
import useLoveSongs from "@/hooks/useLoveSongs";
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:gap-4 gap-2">
        <div className="lg:w-[40%] lg:mt-40 mt-20">
          <div className="fixed w-full lg:w-[50%] lg:bg-transparent z-30 left-0 top-[10%] pb-8 bg-zinc-900 lg:top-[30%] md:top-[13%] lg:ml-4 md:ml-16">
